...
//Hierarchical-Inheritance --> matlab 1 level se jada tak inherit kar pana..
...
public class Encapsulation {
    public static void main(String[] args) {
        Account account1 = new OOPS.Encapsulation.Account();
...
// NOTES:- yeh h Hierarchical Inheritance jaisa ki hum dekh pa rahe h ki hamne
// Shape class bhaya
